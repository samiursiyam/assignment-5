...
const Select = ({ toslecte, settoslecte }: SelectProps) => {
  console.log(toslecte, settoslecte);
  ...
  <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 w-full max-w-md">
    ...
    <p className="text-slate-400 text-sm mt-1">No technologies selected yet.</p>
  ...
  <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 w-full max-w-md">
    {/* Header */}
    <h2 className="text-slate-900 text-xl font-bold">Your Stack</h2>
    <p className="text-slate-400 text-sm mt-1"> {toslecte.length} Technology Selected </p>
  ...
  <button  onClick={() => settoslecte([])} className="text-xl text-red-700 font-bold">
    Remove All
  </button>
</div>
